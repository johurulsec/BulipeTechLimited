...
namespace {
struct qt_meta_tag_ZN16BrowserInterfaceE_t {};
} // unnamed namespace

template <> constexpr inline auto BrowserInterface::qt_create_metaobjectdata<qt_meta_tag_ZN16BrowserInterfaceE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<BrowserInterface, qt_meta_tag_ZN16BrowserInterfaceE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject BrowserInterface::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16BrowserInterfaceE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16BrowserInterfaceE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN16BrowserInterfaceE_t>.metaTypes,
    nullptr
} };
...
void *BrowserInterface::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN16BrowserInterfaceE_t>.strings))
